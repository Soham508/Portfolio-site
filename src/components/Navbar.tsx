...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`sticky max-w-full top-0 z-10 mt-0 sm:m-6 h-28 flex flex-row justify-between items-center ${nav ? '' : '-translate-y-96'} ${scrollPosition > 150 ? 'drop-shadow-lg' : ''}  rounded-lg bg-transparent transition-all duration-500 ease-in-out  `}> {/* Added sticky and background color */}
                <div className={`w-1/4 h-16 rounded-lg ${scrollPosition > 100 ? '-translate-y-96' : ''} items-center gap-x-0 flex flex-row`}>
                    <img src={logo} alt="Website Logo" className="w-24 h-full object-cover rounded-xl" />
                </div>
                ...
                <div className='w-3/4 max-sm:hidden h-full self-end flex flex-row  items-center '>
                    ...
                    <div className='flex h-4/5 m-32 p-4 flex-row justify-center gap-x-6 rounded-lg '>
                        <Link to='/' className="relative hover:shadow-slate-100/30 flex w-24 cursor-pointer items-center justify-center  text-slate-100  font-semibold rounded-lg overflow-hidden hover-effect">
                            <span className="z-10">About</span>
                        </Link>

                        <Link to='/skills' className="relative hover:shadow-slate-100/30 flex w-24 cursor-pointer items-center justify-center  text-slate-100  font-semibold rounded-lg overflow-hidden hover-effect">
                            <span className="z-10">Skills</span>
                        </Link>

                        <Link to='/projects' className="relative hover:shadow-slate-100/30 flex w-24 cursor-pointer items-center justify-center  text-slate-100  font-semibold rounded-lg overflow-hidden hover-effect">
                            <span className="z-10">Projects</span>
                        </Link>

                        <Link to='/contact' className="relative hover:shadow-slate-100/30 flex w-24 cursor-pointer items-center justify-center  text-slate-100  font-semibold rounded-lg overflow-hidden hover-effect">
                ...
                <div
                    className={
                        mobile ? "sm:hidden fixed left-0 top-0 w-full h-screen bg-black/60" : ""
                    }
                >
                    {/* Side Drawer Menu */}
                    <div
